...
impl Config {
    pub fn new(map_size: Vec<u32>, player_number: u32, starting_nodes: u32, starting_distance: u32, starting_boarder_distance: u32, starting_execs: u32) -> Config {
        Config { 
            map_size, 
            player_number, 
            starting_nodes,
    ...
    pub fn read_config() -> Config {
        ...
        Config::new(dimensions, 4, 1, 2, 2, 2)
    }
